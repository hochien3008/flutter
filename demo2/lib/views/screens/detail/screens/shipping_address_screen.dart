import 'package:demo2/controllers/auth_controller.dart';
...
class _ShippingAddressScreenState extends ConsumerState<ShippingAddressScreen> {
  ...
  void initState() {
    super.initState();
    //Read the current user data from provider
            ...
            if (_formKey.currentState!.validate()) {
              ...
              await _authController
                  ...
                  .whenComplete(() {
                    ...
                    Navigator.pop(
                      context,
                    ); //this will close the shipping screen meaning it will take us back to the formal which is the check out
                  });
            } else {
              print('Not valid');
            }
